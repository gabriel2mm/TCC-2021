...
import { BreadCrumbComponent, SearchActivityComponent } from '../index';
...
function AuthenticatedLayoutComponent({ children }) {
    ...
    return (
        <>
                    ...
                    <div className="container px-4 mx-auto md:flex md:items-center">
                        ...
                        <div ref={refMenu} className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                            ...
                            <ul className="flex flex-row justify-around md:justify-center items-center ml-2 mt-5 md:mt-0">
                                ...
                                <li className="antialiased mx-5 text-gray-500 text-2xl flex justify-center items-center py-2 px-2 rounded-full hover:bg-gray-200 focus:bg-gray-200 transition-colors duration-800">
                                    <MessageOutlined />
                                </li>
                                <li className="antialiased text-gray-500 text-2xl flex justify-center items-center py-2 px-2 rounded-full hover:bg-gray-200 focus:bg-gray-200 transition-colors duration-800">
            ...
            <footer className="text-md text-gray-600 text-center pb-5">Todos os direitos reservados. <p><strong>Field Service Cloud &copy; 2021</strong></p> </footer>
        </>
    );
}
