...
function LoginLayoutComponent({ children }) {
    ...
    <div className="h-screen min-h-full w-full grid grid-cols-1 grid-rows-3 md:grid-cols-3 md:grid-rows-1 sm:grid-cols-1 sm:grid-rows-3">
      <div className="w-full bg-white flex flex-row justify-center items-center relative">
        ...
        <h1 className="absolute top-1/2 transform -translate-y-1/2 text-2xl lg:text-3x1 subpixel-antialiased font-bold tracking-tight text-center text-white drop-shadow">
          Field Service Cloud
        </h1>
      </div>
      <div className="row-span-2 sm:row-span-2 md:row-span-1 md:col-span-2 sm:col-span-1 flex flex-1 justify-center items-center bg-gray-200">
        <div className="w-full h-auto md:rounded-2xl md:shadow-2xl sm:m-16 lg:m-48 md:m-16  bg-gray-200 md:bg-gray-100">
