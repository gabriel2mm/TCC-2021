export const configuration = [
    ...
    {group : "Atividades", permissions: [
        {name: "Visualização de atividades", description: "Permite que o usuário logado possa visualizar suas atividades" , permission: "read:activities"},
        {name: "Abrir atividades", description: "Permite que o usuário logado possa criar novas atividades!" , permission: "write:activities"},
        {name: "Gerenciar atividades", description: "Permite que o usuário logado adicione, altere e exclua usuários de sua organização." , permission: "activities"},
    ...
    {group : "Capacidades", permissions: [
        {name: "Visualização de capacidades", description: "Permite que o usuário logado visualiza todas as capacidades cadastrados em sua organização." , permission: "read:capacity"},
        {name: "Gerenciar capacidades", description: "Permite que o usuário logado adicione, altere e exclua todas as capacidades de sua organização." , permission: "write:capacity"}
    ]},
