...
export default function AuthenticatedRoutes(){
    ...
    return (
        <Switch>
            ...
            <Route path="/settings/profiles/:id" exact render={ r => context.containsPermission("write:profile") || context.containsPermission("Admin") ? (<ProfileDetailPage />) :  (<Redirect to="/"></Redirect>)} />
            ...
            <Route path="/settings/groups/:id" exact render={ r => context.containsPermission("write:group") || context.containsPermission("Admin") ? (<GroupDetailPage />) :  (<Redirect to="/"></Redirect>)} />
            ...
            <Route path="/settings/categories/:id" exact render={ r => context.containsPermission("write:category") || context.containsPermission("Admin") ? (<CategoryDetailPage />) :  (<Redirect to="/"></Redirect>)}  />
            ...
            <Route path="/settings/users/:id" exact render={ r => context.containsPermission("write:user") || context.containsPermission("Admin") ? (<UserDetailsPage />) :  (<Redirect to="/"></Redirect>)}  />
            ...
            <Route path="/settings/skills/:id" exact render={ r => context.containsPermission("write:skill") || context.containsPermission("Admin") ? (<SkillDetailPage />) :  (<Redirect to="/"></Redirect>)}/>
            ...
            <Route path="/settings/capacities/:id" exact render={ r => context.containsPermission("write:capacity") || context.containsPermission("Admin") ? (<CapacityDetailPage />) :  (<Redirect to="/"></Redirect>)}/>
            ...
            <Route path="/settings/sla/:id" exact render={ r => context.containsPermission("write:sla") || context.containsPermission("Admin") ? (<SLADetailPage />) :  (<Redirect to="/"></Redirect>)}/>
